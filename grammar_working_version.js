...
module.exports = grammar({
  ...
  rules: {
    ...
    arguments: ($) =>
      choice(
        choice($._arguments, $._primary_arguments),
        seq("(", choice($._arguments, $._primary_arguments), ")")
      ),
    ...
    elvis_expression: ($) =>
      prec.right(seq($._primary_arguments, "?:", $._primary_arguments)),
    ...
    as_expression: ($) => seq($._primary_arguments, $.as, $.identifier),
